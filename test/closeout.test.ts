...
test("buildCloseoutSummaryLines emits a reusable closeout summary", () => {
    ...
    reports: [
      {
        ...
        decisionBasis: ["preserved verified progress", "selected the route closest to the objective"],
        candidateRoutes: ["rewrite broadly", "incremental hardening"],
  ...
  assert.deepEqual(lines, [
    ...
    "decision-mode: goal_directed",
    "decision-basis: preserved verified progress | selected the route closest to the objective",
    "candidate-routes: rewrite broadly | incremental hardening",
